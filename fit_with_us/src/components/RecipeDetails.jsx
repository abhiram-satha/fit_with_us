...
export default function RecipeDetails({ users, recipe, ingredients, setRecipeRecord, newPost}) {
    ...
    <section class="section">
      <div class="columns is-two-thirds">
            ...
            <div class="card-content">
              <div class="media">
                ...
                <div class="media-content">
                  ...
                  <p class="subtitle is-6">Calories Per Serving: {goal_weight < current_weight ? Math.floor(recipe.calories / recipe.yield) : Math.floor(3 *recipe.calories / (recipe.yield))}</p>
                </div>
                <a class="media-right vertical-dots dropdown is-right is-hoverable">
                  <strong class="dropdown-trigger">&#xFE19;</strong>
                  <div class="dropdown-menu is-overlay" id="dropdown-menu" role="menu">
              ...
              <div class="content">
                <form onSubmit={(newPost)} class="mb-4">
                  <Input inputType="textarea" type="text" label="Share your thoughts on this recipe!" placeholder="Create a New Post" buttonName="Submit" />
                  <Button name="Submit"/>
                </form>
              </div>
            </div>
        ...
        <div class="column">
          ...
          <button onClick={() => setRecipeRecord(prev=>prev-1)}>Prev</button>
